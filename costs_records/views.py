...
from .forms import CostForm, InvoiceForm
from django.urls import reverse_lazy


def about(request):
    return render(request, 'costs_records/buttons.html', {'title': 'About'})
...
class AddCostView(TemplateView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return render(request, 'costs_records/add-cost-form.html', {'cost_form': cost_form, 'invoice_form': invoice_form})
